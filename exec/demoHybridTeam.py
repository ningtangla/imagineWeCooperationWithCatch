...
def main():
    ...
    numAIWolves = 1
    actionAIIntervel = 1
    pickleName = str(numSheep) + 'Sheep_' + str(numAIWolves) + 'SR' + '1ActionPer' + str(actionAIIntervel) + 'Step' + '.pickle'
    #pickleName = str(numSheep) + 'Sheep_' + str(numAIWolves) + 'SA' + '1ActionPer' + str(actionAIIntervel) + 'Step' + '.pickle'
    fileName = os.path.join(dirName, '..', 'results', 'drawTraj', pickleName)
